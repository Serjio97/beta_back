...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '../beta_back/public/uploads/team');
  },
...
const caseStudyStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '../beta_back/public/uploads/case-studies');
  },
  filename: function (req, file, cb) {
    const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1e9);
    const ext = path.extname(file.originalname);
...
const styleHeroStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '../beta_back/public/uploads/style');
  },
  filename: function (req, file, cb) {
    const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1e9);
    const ext = path.extname(file.originalname);
...
const PopupoStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '../beta_back/public/uploads/popup');
  },
  filename: function (req, file, cb) {
    const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1e9);
    const ext = path.extname(file.originalname);
...
const blogImageStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '../beta_back/public/uploads/blog');
  },
  filename: function (req, file, cb) {
    const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1e9);
    const ext = path.extname(file.originalname);
